...
def build_about():
    ...
    temp += '<li>There is even a paper written about it: <a href="https://f1000research.com/articles/9-1095/v2" target="_blank">https://f1000research.com/articles/9-1095/v2</a></li></ul>'
    ...
    temp += '<li>Becca Wilson was a UKRI Innovation Fellow with HDR UK [MR/S003959/1].</li>'
