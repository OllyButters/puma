...
def build_help():
    ...
    temp += '<p>Authors can often add whatever they want for their keywords when they submit a paper, this may result in slightly different words for the same thing being used by different papers. Sometimes the author defined keywords are not present in the metadata.</p>'
