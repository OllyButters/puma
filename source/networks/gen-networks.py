#authors (simple, with affiliation)
...
dn = gl.dataNetwork(os.path.join(os.getcwd(), '../cache/alspac/processed/merged'))
loadCleaning()
dn.target_path = '$.author.[*]'
...
f = open(os.path.join(os.getcwd(), '../cache/alspac/processed/authorlinks.cleaned.json'), 'w')
